...
# makes corrections in cd automatically if misspelled
shopt -s cdspell
...
#git-prompt integration setting
if [ -f ~/GitScripts/.gitcompletion.sh -a -f ~/GitScripts/.gitprompt.sh ]; then
...
# BOLD_ORANGE='\033[01;35;5;202m'
# BOLD_BLUE='\033[01;34m'

status_display() {  
	if [[ 0 == $? ]]; then
		echo -ne "\U0001F913 \033[01;32m"
	else 
	 	echo -ne "\U0001f621 \033[01;31m [ $? ]"
	fi
}
